...
class OpenRouterCaller(LLMCaller):
    def __init__(self, vendor: str, model: str, free: bool = True, timeout: tuple[float, float]=(30, 200), core_config: str = './config.json', runtime_config: str = './llm_runtime_config.json'):
    ...
    def _make_model_url(self) -> str:
        ...
        return f"{self.vendor}/{self.model}{suffix}"
...
class GoogleAIStudioLLM(LLMCaller):
    """
